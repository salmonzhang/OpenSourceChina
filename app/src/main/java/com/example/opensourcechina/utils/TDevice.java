...
public class TDevice {
    ...
    public static int getDefaultLoadFactor() {
        if (_loadFactor == null) {
            Integer integer = Integer.valueOf(0xf & Oschina.context
    ...
    public static DisplayMetrics getDisplayMetrics() {
        ...
        ((WindowManager) Oschina.context.getSystemService(
   ...
   /* public static String getUdid() {
    ...
    public static boolean hasBigScreen() {
        ...
        if (_hasBigScreen == null) {
            boolean flag1;
            if ((0xf & Oschina.context.getResources()
    ...
    public static final boolean hasCamera() {
        if (_hasCamera == null) {
            PackageManager pckMgr = Oschina.context
                    .getPackageManager();
            boolean flag = pckMgr
...
/*    public static boolean hasInternet() {
        boolean flag;
        if (((ConnectivityManager) Oschina.context.getSystemService(
    ...
    public static boolean isPackageExist(String pckName) {
        try {
            PackageInfo pckInfo = Oschina.context.getPackageManager()
    ...
    public static boolean isLandscape() {
        boolean flag;
        if (Oschina.context.getResources().getConfiguration().orientation == 2)
            flag = true;
        else
            flag = false;
        return flag;
    ...
    public static boolean isPortrait() {
        boolean flag = true;
        if (Oschina.context.getResources().getConfiguration().orientation != 1)
            flag = false;
        return flag;
    }
    ...
    public static void showSoftKeyboard(View view) {
        if (view == null)
            return;
        /*
        ((InputMethodManager) Oschina.context.getSystemService(
    ...
    public static String getCurCountryLan() {
        return Oschina.context.getResources().getConfiguration().locale
                .getLanguage()
                + "-"
                + Oschina.context.getResources().getConfiguration().locale
                .getCountry();
    }

    public static boolean isZhCN() {
        String lang = Oschina.context.getResources()
    ...
    public static PackageInfo getPackageInfo(String pckName) {
        try {
            return Oschina.context.getPackageManager()
                    .getPackageInfo(pckName, 0);
        } catch (NameNotFoundException e) {
            e.printStackTrace();
        }
    ...
    public static int getVersionCode() {
        int versionCode = 0;
        try {
            versionCode = Oschina.context
                    .getPackageManager()
                    .getPackageInfo(Oschina.context.getPackageName(),
                            0).versionCode;
    ...
    public static int getVersionCode(String packageName) {
        int versionCode = 0;
        try {
            versionCode = Oschina.context.getPackageManager()
    ...
    public static boolean isScreenOn() {
        PowerManager pm = (PowerManager) Oschina.context
    ...
    public static String getIMEI() {
        TelephonyManager tel = (TelephonyManager) Oschina.context
    ...
    public static void openApp(Context context, String packageName) {
        Intent mainIntent = Oschina.context.getPackageManager()
    ...
    public static boolean isWifiOpen() {
        ...
        ConnectivityManager cm = (ConnectivityManager) Oschina.context.getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static void copyTextToBoard(String string) {
        if (TextUtils.isEmpty(string))
            return;
        ClipboardManager clip = (ClipboardManager) Oschina.context
    ...
    public static int getStatuBarHeight() {
        ...
        try {
            ...
            field = c.getField("status_bar_height");
            x = Integer.parseInt(field.get(obj).toString());
            sbar = Oschina.context.getResources()
                    .getDimensionPixelSize(x);
    ...
    public static int getNetworkType() {
        int netType = 0;
        ConnectivityManager connectivityManager = (ConnectivityManager) Oschina.context.getSystemService(Context.CONNECTIVITY_SERVICE);
